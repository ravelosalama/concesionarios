...
-- DETECTA INTENTO DE MODIFICACION DE REGISTROS EN SAOPER_03 Y LO CANCELA

DROP TRIGGER TG_C_NOUPDATE_SAOPER_03
GO

CREATE TRIGGER dbo.TG_C_NOUPDATE_SAOPER_03 ON SAOPER_03 FOR UPDATE
AS
