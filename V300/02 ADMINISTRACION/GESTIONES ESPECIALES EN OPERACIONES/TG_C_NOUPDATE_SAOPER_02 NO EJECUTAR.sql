...
-- DETECTA INTENTO DE MODIFICACION DE REGISTROS EN SAOPER_02 Y LO CANCELA

DROP TRIGGER TG_C_NOUPDATE_SAOPER_02
GO

CREATE TRIGGER dbo.TG_C_NOUPDATE_SAOPER_02 ON SAOPER_02 FOR UPDATE
AS
