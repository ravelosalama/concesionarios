-- NOMBRE DEL OBJETO SEGUN PATRON PARA CONCESIONARIOS VW_C_SBConc
-- QUE HACE
-- RESUELVE QUE NECESIDAD
-- QUE OBJETOS: REPORTES, SP, TG, LO REQUIERE
-- HECHO POR:            FECHA:
 
DROP VIEW dbo.VW_C_SBConc 

GO
CREATE VIEW dbo.VW_C_SBConc
-- WITH ENCRYPTION
...
SET @TNAME = 'VW_C_SBConc'
SET @ALIAS = 'VW_C_SBConc'
