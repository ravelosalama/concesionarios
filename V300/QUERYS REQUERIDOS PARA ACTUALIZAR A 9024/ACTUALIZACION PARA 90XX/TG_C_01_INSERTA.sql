...
-- MODIFICADO FEBRERO 2018, DICIEMBRE 2018.  
...
-- Recoge datos de la tabla: INSERTED
   ...
   IF  ROUND(@total,0)>=ROUND(@totalg,0)
    ...
    BEGIN
       ...
       IF (@CODOPER <> '01-101' AND @CODOPER <> '01-201' AND @CODOPER<> '01-301' AND @CODOPER<>'01-302' AND @CODOPER<>'01-303' AND @CODOPER <> '01-401' AND @CODOPER<> '01-501' AND @CODOPER <> '01-901' and @CODOPER<>'01-304' AND @CODOPER<>'01-305' and @CODOPER<>'01-306') OR (@CODOPER IS NULL)
          BEGIN
